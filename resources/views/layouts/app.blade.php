                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li class=" pb-1 pt-1" >Get great devices up to 50% off <a href="{{route('shop')}}">View details</a></li>
                                    <li class=" pb-1 pt-1">Supper Value Deals - Save more with coupons</li>
                                    <li class=" pb-1 pt-1">Trendy 25silver jewelry, save up 35% off today <a href="{{route('shop')}}">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+212) 60620-3862</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">YassineRoummani</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
