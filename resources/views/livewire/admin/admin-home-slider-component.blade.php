                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($slides as $slide )
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.home.slide.edit',['slide_id'=>$slide->id])}}" class=" text-info" style="margin-left: 20px"  >
                                                        <i class="fi-rs-edit"></i>
                                                    </a>
                                                    <a href="#" class=" text-danger" style="margin-left: 20px" onclick="deleteConfirmation({{$slide->id}})" >
